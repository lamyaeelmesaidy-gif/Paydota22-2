...
## Changelog
- July 15, 2025: تم تفعيل نظام Airwallex الحقيقي بدلاً من وضع المحاكاة - تم تحديث server/airwallex.ts لاستخدام مفاتيح API الحقيقية وإصلاح طريقة المصادقة لإرسال client_id وapi_key في headers بدلاً من body. تم إجبار النظام على استخدام production API عند توفر المفاتيح الحقيقية.
