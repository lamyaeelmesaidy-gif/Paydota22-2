...
## Changelog
- July 15, 2025: تم تفعيل نظام Airwallex Production API بنجاح - تم تحديث server/airwallex.ts لاستخدام Production API مع مفاتيح حقيقية. تم إضافة معلومات تشخيص مفصلة للمصادقة. تم إجبار النظام على استخدام isDemo: false للعمل مع Production API بدلاً من Demo API.
