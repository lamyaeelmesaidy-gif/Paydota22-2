    ...
    <div className="fixed inset-0 w-screen h-screen bg-white dark:bg-gray-900 flex items-center justify-center relative overflow-hidden z-[9999]" style={{ minHeight: '100vh', height: '100dvh' }}>
      ...
      <div className="text-center z-10 px-8">
        ...
        <div className="mb-8">
          <div className="relative">
            <h1 className="text-4xl font-bold mb-2">
              <span className="text-red-600 dark:text-red-400">Apps</span>
        ...
        <div className="relative mb-8">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-32 h-32 relative">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-red-400 rounded-full animate-bounce"></div>
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-semibold bg-gradient-to-r from-red-600 via-pink-500 to-indigo-600 dark:from-red-400 dark:via-pink-400 dark:to-indigo-400 bg-clip-text text-transparent">
            Getting ready...
          </h3>
        ...
        <div className="flex justify-center space-x-2 mt-6">
          ...
          <div className="w-2 h-2 bg-red-400 dark:bg-red-300 rounded-full animate-pulse delay-200"></div>
          <div className="w-2 h-2 bg-red-300 dark:bg-red-200 rounded-full animate-pulse delay-400"></div>
        </div>
      </div>
    </div>
  );
