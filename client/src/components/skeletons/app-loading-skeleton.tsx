      ...
      <div className="text-center z-10 px-8">
        ...
        <div className="relative mb-8">
          ...
          <div className="w-20 h-20 mx-auto relative">
            ...
            <div className="absolute inset-0 border-4 border-transparent border-t-primary border-r-primary/80 rounded-full animate-spin"></div>
            <div className="absolute inset-2 border-2 border-transparent border-t-primary/60 rounded-full animate-spin reverse-spin"></div>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-32 h-32 relative">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-primary/80 rounded-full animate-bounce"></div>
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-primary/60 rounded-full animate-bounce delay-300"></div>
              <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-2 h-2 bg-primary/40 rounded-full animate-bounce delay-150"></div>
              <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-2 h-2 bg-primary/20 rounded-full animate-bounce delay-450"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center space-x-2 mt-6">
          ...
          <div className="w-2 h-2 bg-primary/80 rounded-full animate-pulse delay-200"></div>
