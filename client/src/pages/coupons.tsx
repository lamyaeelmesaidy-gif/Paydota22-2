      ...
      <div className="container mx-auto px-4 py-6 relative z-10 max-w-md space-y-4">
        ...
        <div className="space-y-3">
          ...
          {coupons.filter(coupon => coupon.isActive && !isExpired(coupon.expiryDate)).map((coupon) => (
            <Card key={coupon.id} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-purple-200/30 dark:border-purple-700/30 shadow-lg overflow-hidden">
              <CardContent className="p-0">
                <div className="relative">
                  ...
                  <div className="p-4 space-y-3">
                    {/* Coupon Code */}
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border-2 border-dashed border-purple-300 dark:border-purple-600">
                      ...
                      <Button
                        ...
                        className="h-8 px-2 text-purple-600 hover:text-purple-700 hover:bg-purple-50 dark:hover:bg-purple-900/30"
                      >
