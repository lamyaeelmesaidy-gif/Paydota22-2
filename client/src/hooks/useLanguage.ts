...
const translations = {
  ar: {
    ...
    welcomeMessage: "مرحباً بك في منصة البنك الرقمي",
    getStarted: "ابدأ الآن",
    digitalAccount: "فتح حساب رقمي",
  ...
  en: {
    ...
    welcomeMessage: "Welcome to Digital Banking Platform",
    getStarted: "Get Started",
    digitalAccount: "Open Digital Account",
